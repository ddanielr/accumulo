...
public class TestPrometheusRegistryFactory implements MeterRegistryFactory {

  private static final Logger LOG = LoggerFactory.getLogger(TestPrometheusRegistryFactory.class);
