...
public class ManagerApiIT extends SharedMiniClusterBase {
  ...
  private Function<Credentials,TServerClient.Exec<Void,ManagerClientService.Client>> op;
  ...
  private static void expectPermissionSuccess(
      Function<Credentials,TServerClient.Exec<Void,ManagerClientService.Client>> op,
  ...
  private static void expectPermissionSuccess(
      TServerClient.Exec<Void,ManagerClientService.Client> op, ClientContext context)
      throws Exception {
