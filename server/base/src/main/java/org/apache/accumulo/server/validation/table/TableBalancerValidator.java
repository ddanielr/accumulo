...
public class TableBalancerValidator implements TablePluginValidator {
  ...
  public boolean validate(TableId tableId, ServerContext context) {
    try {
      ...
      // To exercise this table, let's simulate an assignment for the table. This may or may not
      ...
      TabletBalancer.AssignmentParameters assignParams = new AssignmentParamsImpl(currentStatus,
          Map.of(Constants.DEFAULT_RESOURCE_GROUP_NAME, Set.of(tserver1)), unassigned,
          assignmentsOut);
