...
public enum Property {
  ...
  COMPACTION_SERVICE_PREFIX(COMPACTION_PREFIX + "service.", null, PropertyType.PREFIX,
      ...
      "3.1.0"),
  COMPACTION_SERVICE_ROOT_PLANNER(COMPACTION_PREFIX + "root.planner",
      DefaultCompactionPlanner.class.getName(), PropertyType.CLASSNAME,
      "Compaction planner for root tablet service.", "4.0.0"),
  COMPACTION_SERVICE_ROOT_MAX_OPEN(COMPACTION_PREFIX + "root.planner.opts.maxOpen", "30",
      PropertyType.COUNT, "The maximum number of files a compaction will open.", "4.0.0"),
  COMPACTION_SERVICE_ROOT_GROUPS(COMPACTION_PREFIX + "root.planner.opts.groups",
      "[{'name':'accumulo_meta'}]".replaceAll("'", "\""), PropertyType.STRING,
      "See {% jlink -f org.apache.accumulo.core.spi.compaction.DefaultCompactionPlanner %}.",
      "4.0.0"),
  COMPACTION_SERVICE_META_PLANNER(COMPACTION_PREFIX + "meta.planner",
      DefaultCompactionPlanner.class.getName(), PropertyType.CLASSNAME,
      "Compaction planner for metadata table.", "4.0.0"),
  COMPACTION_SERVICE_META_MAX_OPEN(COMPACTION_PREFIX + "meta.planner.opts.maxOpen", "30",
      PropertyType.COUNT, "The maximum number of files a compaction will open.", "4.0.0"),
  COMPACTION_SERVICE_META_GROUPS(COMPACTION_PREFIX + "meta.planner.opts.groups",
      "[{'name':'accumulo_meta'}]".replaceAll("'", "\""), PropertyType.JSON,
      "See {% jlink -f org.apache.accumulo.core.spi.compaction.DefaultCompactionPlanner %}.",
      "4.0.0"),
  COMPACTION_SERVICE_DEFAULT_PLANNER(COMPACTION_PREFIX + "default.planner",
      DefaultCompactionPlanner.class.getName(), PropertyType.CLASSNAME,
      "Planner for default compaction service.", "4.0.0"),
  COMPACTION_SERVICE_DEFAULT_MAX_OPEN(COMPACTION_PREFIX + "default.planner.opts.maxOpen", "10",
      PropertyType.COUNT, "The maximum number of files a compaction will open.", "4.0.0"),
  COMPACTION_SERVICE_DEFAULT_GROUPS(COMPACTION_PREFIX + "default.planner.opts.groups",
